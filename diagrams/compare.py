...
for aspect in result.index:
    plt.plot(result.columns, result.loc[aspect], marker='o', label=aspect)

plt.xlabel("Method")
plt.ylabel("Trust Level (1-5)")
plt.title("Trust Changes Across Explanation Types")
