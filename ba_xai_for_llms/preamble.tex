...
\usepackage{lmodern}
\hyphenation{over-re-pre-sen-ta-tion human-read-able}
...
\hypersetup{%
  pdftitle={Explainable AI for Large Language Models: Technical Explanation Methods and their Impact on User Trust},
% Use \plainauthor for final version.
  pdfauthor={Linda Riesen},
