...
LLMs are susceptible to several distinct failure modes (dishonesty, bias, neglect of relevant factors and hallucination \cite{wu_usable_2025}), yet their outputs are delivered
...
A notable subclass are counterfactual explanations, which characterize a model's
...
moved beyond single-feature perturbations toward actionable, multistep
...
measuring trust across four aspects before and after exposure to each explanation
method.
