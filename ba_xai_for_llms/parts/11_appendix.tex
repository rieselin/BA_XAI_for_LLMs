...
\begin{center}
  \centering
    \includegraphics[page=1,width=1\textwidth]
    {resources/full_questionnaire_cropped.pdf}
\end{center}
...
\begin{figure}[htbp]
  ...
  \caption{Mean Trust per Aspect, Method and Gender\\ A = Factually Accurate, B = Reliable, C = Competent and Knowledgable, D = Tried to answer correctly, E = Would rely on answers}
\end{figure}
